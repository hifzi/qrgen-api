...
function mergeOptions(defaultOptions, customOptions) {
    ...
    // Handle colors
    if (customOptions.darkColor && isValidHexColor(customOptions.darkColor)) {
        merged.color.dark = customOptions.darkColor;
    }
    
    if (customOptions.lightColor && isValidHexColor(customOptions.lightColor)) {
        merged.color.light = customOptions.lightColor;
    }
...
function parseCustomOptions(query) {
    ...
    if (query.errorLevel || query.errorCorrectionLevel) {
        customOptions.errorCorrectionLevel = query.errorLevel || query.errorCorrectionLevel;
    }
    
    if (query.darkColor) {
        customOptions.darkColor = query.darkColor;
    }
    
    if (query.lightColor) {
        customOptions.lightColor = query.lightColor;
    }
